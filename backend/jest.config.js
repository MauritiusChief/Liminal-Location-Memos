...
export default {
  ...
  moduleNameMapper: {
    ...
    "^\\./buildingRecord\\.js$": "<rootDir>/src/services/gameSystem/buildingRecord.ts",
    "^\\./buildingApartment\\.js$": "<rootDir>/src/services/gameSystem/buildingApartment.ts",
    "^\\./buildingApartmentUtility\\.js$": "<rootDir>/src/services/gameSystem/buildingApartmentUtility.ts",
    "^\\./buildingHouse\\.js$": "<rootDir>/src/services/gameSystem/buildingHouse.ts",
    "^\\./buildingHouseAccessory\\.js$": "<rootDir>/src/services/gameSystem/buildingHouseAccessory.ts",
    "^\\./buildingUtils\\.js$": "<rootDir>/src/services/gameSystem/buildingUtils.ts",
